...
public class CheckBattleRankingTest {
    ...
    @Test
    public void test_check_battle_ranking_with_empty_session() throws IOException, ServletException {
        HttpServletRequest request = mock(HttpServletRequest.class);
        HttpServletResponse response = mock(HttpServletResponse.class);
        when(request.getSession()).thenReturn(new HttpSession() {
            @Override
    ...
    @Test
    public void test_check_battle_ranking_doPost() throws IOException, ServletException {
        ...
        checkBattleRanking.doPost(request, response);
